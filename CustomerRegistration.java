...
public class CustomerRegistration extends AppCompatActivity {
    ...
    Button save;
    String ServerURL = "https://learnfriendly.000webhostapp.com/customer.php";
    ...
    public void InsertData(final String name, final String phone, final  String aadhar,final String password,final String address){
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                super.onPreExecute();
                progressDialog = ProgressDialog.show(CustomerRegistration.this, "Just a minute","Wait....", true);
            }
            @Override
            protected void onPostExecute(String result) {
                ...
                Toast.makeText(CustomerRegistration.this, "Data Submit Successfully", Toast.LENGTH_LONG).show();
